...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'portfolio.gamer_desc': '슈퍼패미컴과 PS1을 시작으로 닌텐도 시리즈, PS2, PS3, PS5, Xbox까지 여러 세대의 주요 콘솔과 다양한 장르의 게임을 꾸준히 경험해 온 만큼, 저는 단순한 플레이어를 넘어 게임의 흐름과 감각을 오래 체득해 온 게이머입니다.',
    'about.title': '경험 스토리',
  ...
  en: {
    ...
    'portfolio.gamer_desc': 'Starting with Super Famicom and PS1, and continuing through the Nintendo series, PS2, PS3, PS5, and Xbox, I have consistently experienced various generations of major consoles and game genres. I am more than just a player—I am a lifelong gamer who has deeply embodied the flow and sensation of games.',
