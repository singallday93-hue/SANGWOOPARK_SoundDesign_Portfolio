...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'resume.exp1.subdesc': 'AKMU(악동뮤지션), 넥슨 아이콘 매치 외 다수',
    'resume.exp1.desc': '음악 및 기술 분야 비즈니스 통번역 프리랜서 활동.',
    'resume.exp2.title': '글로벌 A&R 기획 / 투어 매니지먼트',
    ...
    'portfolio.info': '고화질로 감상해주세요.',
    'portfolio.watch': '영상 보기',
    'portfolio.gamer_desc': '슈퍼패미컴과 PS1을 시작으로 닌텐도 시리즈, PS2, PS3, PS5, Xbox까지 여러 세대의 주요 콘솔과 다양한 장르의 게임을 꾸준히 경험해 온 게이머입니다.',
    'portfolio.foley_desc': '직접 녹음한 오리지널 소스를 기반으로 사운드를 디자인하는 과정을 중요하게 생각합니다. 일상에서 발견한 다양한 오브젝트와 Foley를 활용해 단순히 장면을 채우는 소리를 넘어, 각 사운드에 개성과 기억에 남는 특징을 더하려고 합니다.\n\n특히 디자인된 사운드 위에 가공을 최소화한 섬세한 Foley 레이어를 더해 질감과 디테일을 살리는 방식을 사용합니다. 작은 마찰음이나 움직임, 재질의 소리가 더해졌을 때 사운드가 한층 자연스럽고 살아 있는 느낌을 줄 수 있다고 생각하기 때문입니다.\n\n아직 익숙한 방식에 머무르기보다 다양한 녹음 방법과 새로운 소스를 계속 실험하며, 저만의 사운드 라이브러리와 디자인을 만들어가고 있습니다.',
    'about.title': '경험 스토리',
    ...
    'footer.btn.resume': '이력서 & 기획안 다운로드 (PDF)',
  ...
  en: {
    ...
    'resume.exp1.subdesc': 'AKMU, Nexon Icon Match, etc.',
    ...
    'portfolio.subtitle': 'Game Audio',
    'portfolio.info': 'Watch in high quality for the best audio.',
    'portfolio.watch': 'Watch Video',
    'portfolio.gamer_desc': 'Starting with Super Famicom and PS1, and continuing through the Nintendo series, PS2, PS3, PS5, and Xbox, I am a gamer who has consistently experienced various generations of major consoles and game genres.',
    'portfolio.foley_desc': 'I deeply value the process of designing sounds based on original sources that I record myself. By utilizing various everyday objects and Foley, I aim to go beyond simply filling scenes with sound, adding unique personality and memorable characteristics to each audio element.\n\nSpecifically, I layer delicate, minimally processed Foley over designed sounds to bring out texture and detail. I believe that adding subtle friction, movement, or material sounds makes the audio feel much more natural and alive.\n\nRather than settling for familiar methods, I continue to experiment with diverse recording techniques and new sources, building my own unique sound library and signature design.',
    ...
    'footer.btn.resume': 'Resume & Proposal Download (PDF)',
